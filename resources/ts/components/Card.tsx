...
export const Card:FC = () => {
    ...
    return(
        <>
            <Link to={`/flashcard/${card.flashcard_id}`}>{card.flashcard_title}</Link>

            <div className="w-96 ml-auto mr-auto text-right text-xs">編集:{card.created_at}</div>
            <div className="w-96 ml-auto mr-auto border /border-gray-300 rounded-lg bg-white shadow-2xl overflow-hidden">
