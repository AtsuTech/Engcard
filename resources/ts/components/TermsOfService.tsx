...
export const TermsOfService:FC = () =>{
    document.title = "利用規約";
    return(
        <div className="bg-white md:shadow-lg px-10">

            <h1 className="text-2xl md:text-3xl text-center py-10">利用規約</h1>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第1条（適用）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第2条（利用登録）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第3条（ユーザーIDおよびパスワードの管理）</h2>
            ...
            {/* <section className="py-3">
                <h2 className="text-2xl py-1">第4条（利用料金および支払方法）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第4条（禁止事項）</h2>
                ...
                <ul className="list-disc pl-6 py-4">
                    ...
                    <li>以下の表現を含み，または含むと当社が判断する内容を本サービス上に投稿し，または送信する行為
                        <ul className="list-decimal pl-6 py-4">
                            <li>過度に暴力的な表現</li>
                            <li>露骨な性的表現</li>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第5条（本サービスの提供の停止等）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第6条（著作権）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第7条（利用制限および登録抹消）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第8条（退会）</h2>
                <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
            </section>

            <section className="py-3">
                <h2 className="text-2xl py-3">第10条（保証の否認および免責事項）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第9条（サービス内容の変更等）</h2>
                <p>当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
            </section>


            <section className="py-3">
                <h2 className="text-2xl py-3">第10条（利用規約の変更）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第11条（個人情報の取扱い）</h2>
                <p>当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
            </section>

            <section className="py-3">
                <h2 className="text-2xl py-3">第12条（通知または連絡）</h2>
            ...
            <section className="py-3">
                <h2 className="text-2xl py-3">第13条（権利義務の譲渡の禁止）</h2>
                <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
            </section>

            <section className="py-3">
                <h2 className="text-2xl py-3">第14条（準拠法・裁判管轄）</h2>
            ...
            <footer>
                <div className="py-10">
                    <div className="text-right">2024年6月22日 制定</div>
                    <div className="text-right  text-2xl">Engcard</div>
                </div>
            </footer>
